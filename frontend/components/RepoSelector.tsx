...
export default function RepoSelector({ repos, selected, onSelect, loading }: RepoSelectorProps) {
  ...
  if (!loading && repos.length === 0) {
    return <p className="text-sm text-gray-500 py-2">No repositories found for this account.</p>
  }
